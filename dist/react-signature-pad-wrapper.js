...
var throttle$3 = ( throttle$2 && throttle$1 ) || throttle$2;
...
var SignaturePad$1 = function (_PureComponent) {
    inherits(SignaturePad$$1, _PureComponent);

    function SignaturePad$$1(props) {
        classCallCheck(this, SignaturePad$$1);

        var _this = possibleConstructorReturn(this, (SignaturePad$$1.__proto__ || Object.getPrototypeOf(SignaturePad$$1)).call(this, props));
    ...
    createClass(SignaturePad$$1, [{
        ...
        value: function componentDidMount() {
            if (this._canvas) {
                ...
                this._signaturePad = new SignaturePad(this._canvas, this.props.options);
            }
        }
    }, {
